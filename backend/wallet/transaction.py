...
class Transaction:
    ...
    def update(self, sender_waller, recipient, amount):
        """
        ...
        :return:
        """
        if amount > self.output[sender_waller.address]:
            raise Exception('Amount exceeds balance')
        ...
        self.output[sender_waller.address] -= amount

        self.input = self.create_input(sender_waller, self.output)

...
class Wallet:
    ...
    def calculate_balance(blockchain, address):
        """
        Calculate the balance of the give address considering the transaction data within the blockchain.
        ...
        for block in blockchain.chain:
            for transaction in block.data:
                if transaction['input']['address'] == address:
                    # Any time the address conducts a new transaction te resets its balance
